...
class Alieno(pygame.sprite.Sprite):
    ...
    def aggiorna_frame(self):
        # Alterna tra i due frame in base al contatore globale
...
class Esplosione(pygame.sprite.Sprite):
    def __init__(self, centro_x, centro_y):
        ...
        self.frame_rimanenti = 25  # frame di durata visibile
...
class Gioco:
    ...
    def _inizializza_partita(self):
        ...
        # Resetta il contatore di animazione degli alieni
    ...
    def _genera_alieni(self):
        # Popola la griglia: NUMERO_RIGHE_ALIENI righe x NUMERO_COLONNE_ALIENI colonne
        indice_riga = 0
    ...
    def _gestisci_sparo_alieni(self):
        ...
        proiettile_alieno = Proiettile(
            alieno_sparatore.rect.centerx,
            alieno_sparatore.rect.bottom,
            VELOCITA_PROIETTILE_ALIENO,
            ROSSO
        )
    ...
    def _controlla_collisioni(self):
        ...
        alieni_colpiti = pygame.sprite.groupcollide(
            self.gruppo_alieni, self.gruppo_proiettili_giocatore, True, True)
        ...
        # Proiettile giocatore contro UFO
        ufo_colpiti = pygame.sprite.groupcollide(
            self.gruppo_ufo, self.gruppo_proiettili_giocatore, True, True)
        ...
        # Proiettile giocatore contro barriere
        ...
        # Proiettile alieno contro barriere
    ...
    def _disegna_hud(self):
        ...
        testo_ondata = self.carattere_piccolo.render(
            f"ONDATA: {self.numero_ondata}", True, GIALLO)
    ...
    def _disegna_schermata_gameover(self):
        ...
        testo_punteggio_finale = self.carattere_piccolo.render(
                    ...
                    if self.stato_gioco == "menu" and evento.key == pygame.K_RETURN:
                        ...
                        if evento.key == pygame.K_SPACE:
                            ...
                            if self.giocatore.sta_morendo == False and nessun_proiettile_attivo == True:
                                nuovo_proiettile = Proiettile(
                                    self.giocatore.rect.centerx,
                                    self.giocatore.rect.top,
                                    -VELOCITA_PROIETTILE_GIOCATORE,
                                    BIANCO
                                )
